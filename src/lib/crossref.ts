...
const SEARCH_QUERY_SPECS: CrossRefQuerySpec[] = interleaveCrossRefQueries([
  ...
  { query: "benchmark design manager evaluation pension assets", mode: "default" },
  { query: "manager evaluation pension fund benchmark", mode: "default" },
  { query: "factor based asset allocation global pension portfolio", mode: "default" },
  { query: "strategic asset allocation public pension funds dynamic", mode: "default" },
